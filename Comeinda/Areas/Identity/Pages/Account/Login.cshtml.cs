...
namespace Comeinda.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly UserManager<CastomUser> _userManager;
        private readonly IUserRepository<CastomUser> _userRepository;
        private readonly SignInManager<CastomUser> _signInManager;
        private readonly ILogger<LoginModel> _logger;

        public LoginModel(SignInManager<CastomUser> signInManager,
            ILogger<LoginModel> logger,
            UserManager<CastomUser> userManager,
            IUserRepository<CastomUser> userRepository)
        {
